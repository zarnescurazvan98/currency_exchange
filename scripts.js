...
const dataAPI ='http://api.exchangeratesapi.io/v1/latest?access_key=9c31ecfec7b2888ef76a08c36bcd1104';

const initiallyDisplayedCurrencies = ['EUR', 'USD', 'RUB', 'GBP', 'JPY', 'AUD'];
let baseCurrency;
let baseCurrencyAmount;

// Variable for different currencies (I can't get these keys from the API so i put them in here as mock up data)
let currencies = [
	{
		name: 'Euro',
		abbreviation: 'EUR',
...
// --- Event listeners + functions for them ---

// Toggle add currency list listener and function
...
// Add currency listener and function
...
// Remove currency listener and function
...
// Setting new base currency function
...
// Changing base currency by input listener and function
...
// Function for when out of focus to put .0000 after the entered value
...
// Function for when press enter key to put .0000 after the entered value
...
// --- Populate with data functions ---

// Populate the add currency list with currencies function
...
// Populate the currencies list from currencies function
...
// Create new currencies LI item function
...
// Fetch data from API URL function
fetch(dataAPI)
	.then((res) => res.json())
	.then((data) => {
		console.log(data);
